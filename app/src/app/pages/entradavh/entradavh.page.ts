...
@Component({
  selector: 'app-entradavh',
  templateUrl: './entradavh.page.html',
  styleUrls: ['./entradavh.page.scss'],
  standalone: true,
  imports: [CommonModule, IonicModule, FormsModule, ReactiveFormsModule, HeaderComponent, FooterComponent],
})
export class EntradavhPage implements OnInit {
  ...
  constructor( private _sesion : SessionsService,
    ...
    this.form = this.fb.group({
      ...
      fechaEntrada: [fechaHoraColombia.fecha, Validators.required],
      horaEntrada: [fechaHoraColombia.hora, Validators.required],
    });
